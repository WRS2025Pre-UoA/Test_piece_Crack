...
def main():
    ...
    image_path = 'Test_piece_Crack_Image/2_30cm_15cm_30.jpg'  # 画像のパスを指定
    ...
    cv2.resizeWindow('Warped Image', 600, 600)  # ウィンドウサイズの設定
    ...
    cv2.createTrackbar('Max Line Gap', 'Warped Image', 5, 100, update_image) 
